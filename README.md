<h3>who I am?!</h3>
<p>
My journey into programming didn’t start with `passion` — it started with `FEAR`.
I was genuinely scared of code. I didn’t think I could ever understand it.  
But one day, I decided to `face that fear head on` — just to see if it was really as scary as I thought.
And guess what? I `fell in love with it.`
